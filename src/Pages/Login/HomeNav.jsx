    ...
    <div className="container-fluid w-100 h-100">
      <div className="row">
        ...
        <div className="col-10">
          <nav className="navbar navbar-expand-lg border-bottom border-1 border-dark">
            <div className="navbar-nav">
              <ul className="navbar-nav">
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <a
                        ...
                        href="#"
                        onClick={() => handleMenuClick("NewCompany")}
                      >
                        Add New
                      </a>
                    </li>
                ...
                <li className="nav-item dropdown mx-2 mt-2">
                  ...
                  <span className="badge text-primary fs-6 fw-normal" href="#">
                    Product
                  </span>
                  <ul className="dropdown-menu">
                    <li>
                ...
                <li className="nav-item dropdown mx-2 mt-2">
                  ...
                  <span className="badge text-dark fs-7 fw-normal" href="#">
                    Quotation
                  </span>
                  <ul className="dropdown-menu">
                    <li>
                ...
                <div className="vr mt-2 text-dark fs-7 fw-normal vr-style"></div>
                <li className="nav-item dropdown mx-3">
                  <a className="nav-link" href="#">
                    To-Dos
                  </a>
      ...
      {showNewUser ? (
        ...
        <NewCompany handleMenuClick={handleMenuClick} />
      ) : (
        <HomeCarousel />
      )}
    </div>
